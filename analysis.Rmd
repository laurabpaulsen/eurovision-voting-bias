...
```{r}
pacman::p_load(tidyverse, ggplot2, tmap,raster, sf, rnaturalearth,rnaturalearthdata,RColorBrewer)
```
...
countries_full_facet$plot <- c(rep("Cultural neighbours: Jury",74), rep("Cultural neighbours: Televoters",74), rep("Geographic neighbours: Jury", 74), rep("Geographic neighbours: Televoters", 74))
